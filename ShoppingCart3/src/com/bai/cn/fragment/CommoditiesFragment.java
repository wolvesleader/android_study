 ...
 * 
 */
public class CommoditiesFragment extends BaseFragment implements OnResultListener2{
	...
	public void initData() {
		 ...
		 * map.put("id", orderId);
		 */
		HttpHelper.post("http://192.168.1.101:8080/bai_commodities.json", null, this,
				0);
	}
	...
	public void getResult(String result, int flag) {
		switch (flag) {
		case 0:
			Electronic electronicInfos = JsonUtil.parseJsonToBean(result,
					Electronic.class);

			CategoryAdapter categoryAdapter = new CategoryAdapter(
					electronicInfos.allList, getActivity());
